    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "📝 Don't miss the office hours (Jun 1, 10am EST): LLMops 101 & Evals 101", link: { label: 'Join Here', href: 'https://meet.google.com/wft-ovky-cvb' } },
        ],
      },
      {
        type: 'community',
        items: [
          ...
          {
            text: 'Next batch starts soon. Know someone who should join?',
...
export default function AgendaSummer26Page() {
  ...
  return (
    <>
      <Helmet>
        <title>Summer '26 Agenda | MyRealProduct</title>
        <meta
          name="description"
          content="Full agenda for MyRealProduct Summer 2026 cohort: 4 weeks of ideation, MVP building, deployment, and launch."
        />
      </Helmet>
